...
.. py:class:: RichMemZstdCompressor
    ...
    Since it can only generates individual :ref:`frames<frame_block>`, it's not suitable for stream compression, otherwise the compression ratio will be reduced. For stream compression, see :ref:`this section<stream_compression>`.
...
.. py:class:: EndlessZstdDecompressor
    ...
    Stream decompressor, can be used in these scenarios:

        * Decompress multiple concatenated :ref:`frames<frame_block>`
    ...
    .. sourcecode:: python
        ...
        # --- stream decomression, unlimited output ---
        ...
        # --- stream decomression, limited output ---
        ...
        # reuse a stream object may eliminate the small overhead of creating
