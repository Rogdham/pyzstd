...
.. py:class:: ZstdCompressor
    ...
    .. py:attribute:: CONTINUE
        ...
        Used for *mode* argument of :py:meth:`ZstdCompressor.compress`.
    ...
    .. py:attribute:: FLUSH_BLOCK
        ...
        Used for *mode* argument of :py:meth:`ZstdCompressor.compress`, :py:meth:`ZstdCompressor.flush`.
    ...
    .. py:attribute:: FLUSH_FRAME
        ...
        sed for *mode* argument of :py:meth:`ZstdCompressor.compress`, :py:meth:`ZstdCompressor.flush`.
