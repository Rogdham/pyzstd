...
.. note:: Frame and block
    ...
    In ``pyzstd`` module, :py:class:`ZstdCompressor` can still compress data after end a frame. :py:class:`ZstdDecompressor` doesn't have a .eof maker, can decompress data endlessly as long as data is provided.
...
.. py:class:: ZstdCompressor
    ...
    .. py:method:: compress(self, data, mode=ZstdCompressor.CONTINUE)
        ...
        .. hint:: Why there is a *mode* parameter?
            ...
            #. Can reuse :py:class:`ZstdCompressor` object for big number of same type individual data, make operate in different threads conveniently.
