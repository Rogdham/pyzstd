...
/* Generate two functions using macro:
    1, set_d_parameters(ZstdDecompressor *self, PyObject *option)
    2, load_d_dict(ZstdDecompressor *self, PyObject *dict) */
#undef  PYZSTD_DECOMPRESSOR_CLASS
#define PYZSTD_DECOMPRESSOR_CLASS     ZstdDecompressor
#undef  PYZSTD_DECOMPRESSOR_PREFIX
#define PYZSTD_DECOMPRESSOR_PREFIX(F) F
